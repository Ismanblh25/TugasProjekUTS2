            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="index.php?page=produk/list">
                            <div class="sb-nav-link-icon"><i class="fas fa-wrench"></i></div>
                            Produk
                        </a>
                        <a class="nav-link" href="index.php?page=kategori_produk/list">
                            <div class="sb-nav-link-icon"><i class="fas fa-solid fa-layer-group"></i></div>
                            Kategori Produk
                        </a>
                        <a class="nav-link" href="index.php?page=pesanan/list">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="my-4 fw-bolder">Dashboard Fashion Store</h1>